...
export const mapFontData = async (ctx: GameGLContext) => await GameFont.fromRaw(ctx, "./../../../resources/fonts/overpass-regular.png", "./../../../resources/fonts/overpass-regular.json");